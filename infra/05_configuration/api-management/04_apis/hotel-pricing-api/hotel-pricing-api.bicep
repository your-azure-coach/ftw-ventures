...
module shared '../../../../infra-shared.bicep' = {
  name: 'shared-infra-hotel-pricing-api-${deploymentId}'
  params: {
    envName: envName
  }
}
...
module naming '../../../../infra-naming.bicep' = {
  name: 'naming-hotel-pricing-api-${deploymentId}'
  params: {
    envName: envName
    purpose: 'app-hotels'
  }
...
resource hotelPricingApiContainerApp 'Microsoft.App/containerApps@2022-06-01-preview' existing = {
  name: replace(replace(infraParameters.naming.containerApp, '{purpose}', 'hotel-pricing'), '{env}', envName)
...
module api '../../../../modules/api-management-api.bicep' = {
  ...
  params: {
    ...
    definitionUrl: 'https://${hotelPricingApiContainerApp.properties.configuration.ingress.fqdn}/graphql'
    version: 'v1'
    tags: [
      'System'
    ]
...
module apiLogger '../../../../modules/api-management-app-insights-api-logger.bicep' = {
  scope: az.resourceGroup(apimResourceGroupName)
  name: 'apim-hotel-pricing-api-logger-${deploymentId}'
  params: {
    apimName: shared.outputs.apiManagementName
